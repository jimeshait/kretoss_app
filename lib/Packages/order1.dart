...
class Order1 extends StatefulWidget {
  Order1({super.key, required this.package, required this.index});
  List package;
  int index;
  @override
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                  ...
                                  child: Text(
                                    'Package Web Development ${widget.package[widget.index]['type']}',
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      right: 15.0, top: 25.0),
                                  child: Text(
                                    'Your Package:- Web Development: ${widget.package[widget.index]['type']}: ${widget.package[widget.index]['price']} ',
                                    style: GoogleFonts.sourceSansPro(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                        color: Color(0xff292930)),
                                          ...
                                          Future.delayed(Duration(seconds: 2),
                                            ...
                                            if (iscap == true &&
                                              ...
                                              final String subject =
                                                  'Order For Package:- Web Development: ${widget.package[widget.index]['type']}: ${widget.package[widget.index]['price']}';
                                              final String body =
