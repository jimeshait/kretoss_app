...
class Order2 extends StatefulWidget {
  Order2({super.key, required this.package, required this.index});
  List package;
  int index;
  @override
  State<Order2> createState() => _OrderState();
}

class _OrderState extends State<Order2> {
  @override
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                  ...
                                  child: Text(
                                    'Package Mobile App Design ${widget.package[widget.index]['type']}',
                            ...
                            //     child: Text(
                            //       widget.package[widget.index]['type'],
                            //       textAlign: TextAlign.left,
                            //       style: GoogleFonts.sourceSansPro(
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      right: 15.0, top: 25.0),
                                  child: Text(
                                    'Your Package:- Mobile App Design: ${widget.package[widget.index]['type']}: ${widget.package[widget.index]['price']}',
                                    style: GoogleFonts.sourceSansPro(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                        color: Color(0xff292930)),
                                          ...
                                          Future.delayed(Duration(seconds: 2),
                                            ...
                                            if (iscap == true &&
                                              ...
                                              final String subject =
                                                  'Order For Package:- Mobile App Design: ${widget.package[widget.index]['type']}: ${widget.package[widget.index]['price']}';
                                              final String body =
