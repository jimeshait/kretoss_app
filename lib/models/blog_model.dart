...
List<BlogDetail> blogDetailFromJson(String str) =>
    List<BlogDetail>.from(json.decode(str).map((x) => BlogDetail.fromJson(x)));

String blogDetailToJson(List<BlogDetail> data) =>
