...
//
//     final blogImage = blogImageFromJson(jsonString);

import 'dart:convert';

BlogImage blogImageFromJson(String str) => BlogImage.fromJson(json.decode(str));

String blogImageToJson(BlogImage data) => json.encode(data.toJson());
