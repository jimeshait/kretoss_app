...
//
//     final blogCateg = blogCategFromJson(jsonString);

import 'dart:convert';

BlogCateg blogCategFromJson(String str) => BlogCateg.fromJson(json.decode(str));

String blogCategToJson(BlogCateg data) => json.encode(data.toJson());
...
class BlogCateg {
  ...
  factory BlogCateg.fromJson(Map<String, dynamic> json) => BlogCateg(
        id: json["id"],
        count: json["count"],
