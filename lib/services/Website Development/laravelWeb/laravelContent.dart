...
class LaravelContent extends StatelessWidget {
  const LaravelContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'We offer scalable Laravel Development Services in USA, India, and across the globe. Contact us for high-quality Laravel Web Development for your project.',
              textScaleFactor: 1.2,
